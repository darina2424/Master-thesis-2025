...
periods <- paste0("T",1:10)

heatmap_data <- read.xlsx("HHeatmap_data_all_T1-T10.xlsx")
...
pdf("all_T1-T10.COG_bar.pdf", width = 14, height = 2)
...
pdf("all_T1-T10.COG_heatmap.top25.pdf", width = 5, height = 6)
...
pdf("all_T1-T10.COG_heatmap.pdf", width = 10, height = 8)
