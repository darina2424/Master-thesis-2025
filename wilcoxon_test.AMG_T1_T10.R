...
data_filtered <- data_filtered %>%
  ...
  mutate(annotation = str_wrap(sapply(AMG_KO_name, trim_annotation), width = 120))
...
# pdf("P_value_B_AMG.T1_T10.pdf",width = 20,height = 18)
# gridExtra::grid.arrange(p$gtable)
# dev.off()
# openxlsx::write.xlsx(wilcox_results, file = "AMG_T1-T10_pvalue.xlsx")
